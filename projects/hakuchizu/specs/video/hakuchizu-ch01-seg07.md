# ═══ 演出要約 ════════════════════════════════════
# 『白地図』第1章「暖簾」 / モンタージュ / motion —— 白い布の上に、薄い鉛筆の格子が浮かぶ
#
#   白い布の上に、薄い鉛筆の格子が一本ずつ浮かぶ。桝目の中は空のままで、色はまだ来ない。
#   9秒。切らない——覚えている形は、すべて同じ一枚の布の上に順に置かれる。
#   縦の線が先で、横が後である。布に載るのは格子だけで、手も、頭も、品も描かない。
# ═════════════════════════════════════════════════
