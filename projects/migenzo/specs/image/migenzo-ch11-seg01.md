...
- 生成物の置き場: このディレクトリ。
  ⚠️ **第一世代が在る**——`11_01_ChatGPT Image 2026年9月23日 03_28_57.png`（2026-09-23、著者が投入）。
  ⛔ **これは焼き直しと裁定された**（2026-09-23、著者）——**仕様の側は直した**（縁の3節。下の節）。
  ⚠️ **そして、焼き直しは、まだ行われていない**（**実測**、2026-09-24——このディレクトリの `11_01_*` は、この1枚だけである）。
  ⛔ **ゆえに、この1本は、まだ採用されていない**——**01 と同じく、裁定待ちである。**
