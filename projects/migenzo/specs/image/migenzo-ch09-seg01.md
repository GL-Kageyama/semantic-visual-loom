...
- `LOCATION`: the last darkroom — inside the island of light there are only the tray with its blank white sheet lying in the liquid and the open empty drawer, and everything past the reach of the light is not wall but darkness
