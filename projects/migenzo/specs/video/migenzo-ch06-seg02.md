...
#
# ⚠️ **この1本は `meaning-responsive` を名乗る**（`shots/migenzo-ch06-seg02.yaml`）——
#   ⛔ **§6 `REFERENCES` の `REF_FORMAT:` にその名が入るのは、§1–20 を書く段である。**
#   ⚠️ **ここで §10 が負うのは、文法の一行である**——
#   「**The camera may not tilt, push, or cut to express it** — a camera move is a
