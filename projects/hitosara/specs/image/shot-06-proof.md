...
A luminous realist anime illustration of a wide ceramic bowl under a coarse linen cloth, the cloth
lifted from below by the dough, rising with nothing pushing it, at a wooden bench in a one-room
bakery at midday, with the warm gold light of midday lying flat across the linen as the strongest
highlight. A scene board for the master staging of this one scene, in 16:9 — the camera and the
light fixed as the standard every cut of the scene must match. Flat midday light lies across the
lifted linen. Hyper-detailed layered light: the shaft falling through the air above the bowl, bloom
around the window at the frame edge, flour dust suspended and individually rendered rather than a
flat wash. A saturated palette of magenta and gold on the lit cloth against deep cyan in the room
behind, with flour slipping from the rim of the cloth and caught in the light. Composition level and
close, the bowl across the lower two thirds with the lifted cloth as the single raised point and the
air above it left open; the cloth small and subordinate to the light. Clean anime lineart on the
linen, held below the light. No figure in frame, no hands — the dough itself is what moves. One
focal point, generous negative space.
